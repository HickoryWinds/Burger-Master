...
#### To devour a burger, the user clicks on the 'Devour' button.

![picture](/public/assets/img/devour.png)

#### The burger that has been devoured will move from the 'To Be Eaten' column to the 'In the Pit' column.
...
#### This app was developed using node.js, express, express-handelbars, mysql, jQuery, and CSS technologies. Development was by a sole contributor which is myself.